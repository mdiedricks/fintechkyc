    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                ...
                return [4 /*yield*/, validateUserInput(userRequestObject)];
            case 1:
                validatedUserObject = _a.sent();
                return [4 /*yield*/, makeApiRequest(validatedUserObject)];
            case 2:
                apiResponse = _a.sent();
...
var validateUserInput = function (userInputObject) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0: return [4 /*yield*/, userInputObject];
            case 1:
                validatedUserInput = _a.sent();
                // TODO run checks on userInput
                return [2 /*return*/, validatedUserInput];
        }
    });
}); };
function makeApiRequest(reqObject) {
...
var runResponseCheck = function (apiBlob) {
